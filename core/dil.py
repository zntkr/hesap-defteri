...
TR: Dict[str, Any] = {
    ...
    "disc_info_error": "Geçersiz tutar!",
    ...
    "chng_info_error": "Eski ve yeni değer eksik!",
    ...
    "age_res_completed": " yaşınızı doldurdunuz ve ",
    ...
    "age_res_lived_end": " gün yaşadınız.",
}
...
EN: Dict[str, Any] = {
    ...
    "guide_content": [
        ("ACCOUNT BOOK TOOLS\n", "header"),
        ("• ", "bullet"), ("Tabbed Layout: ", "highlight"), ("Switch instantly between tools (Average, VAT, Age, etc.) by clicking the tab ears at the top.\n", "normal"),
        ("• ", "bullet"), ("Smart Paste: ", "highlight"), ("Paste any text directly. The system ignores letters and automatically extracts numbers (TR/US format).\n", "normal"),
        ("• ", "bullet"), ("Tap to Copy: ", "highlight"), ("Click any calculated result to instantly copy it to the clipboard.\n", "normal"),
        ("KEYBOARD SHORTCUTS\n", "header"),
        (" [ Enter ] ", "key"), ("    Triggers calculation in the active tool.\n", "normal"),
        (" [ ESC ] ", "key"), ("      Clears data and refocuses the cursor.\n", "normal"),
        (" [ Ctrl+Tab ] ", "key"), (" Cycles through tabs (tools) in order.\n", "normal"),
        (" [ Ctrl+1..6 ] ", "key"), (" Jump directly to any tool.\n", "normal"),
        (" Right Click ", "key"), ("  Opens standard Cut/Copy/Paste menu.\n", "normal"),
        ("OTHER FEATURES\n", "header"),
        ("• ", "bullet"), ("View ", "highlight"), ("menu: pin the window always on top.\n", "normal"),
    ],
    ...
    "disc_info_error": "Invalid amount!",
    ...
    "chng_info_error": "Old and new values are missing!",
    ...
    "age_res_days_section": " days\n\n• Milestone: You have completed ",
    "age_res_completed": " full years. You are now progressing through year ",
    "age_res_taking": ".\n\n• Born on: ",
    "age_res_next_bd": "\n\n• Next Birthday: ",
