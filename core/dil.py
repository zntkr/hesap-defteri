...
TR: Dict[str, Any] = {
    ...
    "guide_content": [
        ...
        ("• ", "bullet"), ("Sekmeli Yapı: ", "highlight"), ("Araçlara (Ortalama, KDV vb.) üstteki sekmelerden anında geçiş yapın.\n", "list_item"),
        ("• ", "bullet"), ("Agnostik Veri Girişi: ", "highlight"), ("Metinleri doğrudan yapıştırın. Sistem sayıları otomatik ayıklar.\n", "list_item"),
        ("• ", "bullet"), ("Dokunsal Kopyalama: ", "highlight"), ("Hesaplanan sonuca tıklayarak anında panoya kopyalayın.\n", "list_item"),
        ("KLAVYE KISAYOLLARI\n", "header"),
        (" Enter ", "key"), ("\tHesaplamayı tetikler.\n", "shortcut"),
        (" ESC ", "key"), ("\tVerileri temizler ve odaklar.\n", "shortcut"),
        (" Ctrl+Tab ", "key"), ("\tSekmeler arası gezinir.\n", "shortcut"),
        (" Ctrl+1..6 ", "key"), ("\tİlgili araca doğrudan geçer.\n", "shortcut"),
        (" Sağ Tık ", "key"), ("\tStandart menüyü açar.\n", "shortcut"),
        ("DİĞER ÖZELLİKLER\n", "header"),
...
EN: Dict[str, Any] = {
    ...
    "guide_content": [
        ("ACCOUNT BOOK TOOLS\n", "header"),
        ("• ", "bullet"), ("Tabbed Layout: ", "highlight"), ("Switch instantly between tools using the top tabs.\n", "list_item"),
        ("• ", "bullet"), ("Smart Paste: ", "highlight"), ("Paste any text directly. The system automatically extracts numbers.\n", "list_item"),
        ("• ", "bullet"), ("Tap to Copy: ", "highlight"), ("Click any calculated result to instantly copy it to the clipboard.\n", "list_item"),
        ("KEYBOARD SHORTCUTS\n", "header"),
        (" Enter ", "key"), ("\tTriggers calculation.\n", "shortcut"),
        (" ESC ", "key"), ("\tClears data and refocuses.\n", "shortcut"),
        (" Ctrl+Tab ", "key"), ("\tCycles through tabs.\n", "shortcut"),
        (" Ctrl+1..6 ", "key"), ("\tJumps directly to a tool.\n", "shortcut"),
        (" Right Click ", "key"), ("\tOpens standard edit menu.\n", "shortcut"),
        ("OTHER FEATURES\n", "header"),
